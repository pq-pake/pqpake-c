#include <stdint.h>
#ifndef PAKE_IC_ENCODE_H
#define PAKE_IC_ENCODE_H
#define PAKE_IC_ENC_INPUT_SIZE 1536
#define PAKE_IC_ENC_OUTPUT_SIZE 1498

/**
 * @param input size : PAKE_IC_ENC_INPUT_SIZE (1536)
 * @param output size : PAKE_IC_ENC_OUTPUT_SIZE (1498)
...
/**
 * @param input size : PAKE_IC_ENC_OUTPUT_SIZE (1498)
 * @param output size : PAKE_IC_ENC_INPUT_SIZE (1536)
